        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div>
            ...
            <div className="mt-12">
              <Link
                href="/about"
                className="inline-flex items-center gap-2 text-xs font-medium tracking-[0.2em] uppercase text-black hover:gap-4 transition-all"
              >
                Descubre más
                <ArrowRight size={14} />
              </Link>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -left-8 w-48 h-48 bg-black rounded-sm flex items-center justify-center">
